...
insert into user(id, email, password, authorities, enabled) values(1, 'user', '$2a$10$KoxHNdhOe6OY88Ybq6T2d.SGp6lVfj5ynY/QwaO5SRk998TgnYayi', 'ADMIN', true); -- password = 'password' BCrypt 10 hashed
